"""Discord pagination utilities with buttons for Admin Bot."""
...
def paginate_items(
    ...
    Args:
        ...
        footer_base: Base text for footer
    ...
    for page_num in range(total_pages):
        ...
        if total_pages > 1:
            embed.set_footer(text=f"Page {page_num + 1}/{total_pages} | Total: {len(items)} | {footer_base}")
        else:
            embed.set_footer(text=f"Total: {len(items)} | {footer_base}")
