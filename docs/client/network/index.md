...
| **TCP/TLS** | 4125 | Authentification (TLS 1.2+) | ✅ Implémenté |
...
| Protocol binaire | ✅ Implémenté | 100% | 62 types de messages |
...
// [2025-11-20 22:45:12.456] [info] [Network] Connecting to 127.0.0.1:4125...
...
```bash
# Capturer trafic TCP port 4125
sudo wireshark -i lo -f "tcp port 4125"
```
...
9. ~~**Encryption** (TLS/DTLS)~~ ✅ Implémenté (TLS 1.2+ sur TCP 4125)
